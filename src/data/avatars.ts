 ...
 *
 * เดิมมีสองตัว ซึ่งตอนนั้นก็คือหนึ่งในสามของตัวละครทั้งหมด
 * พอเพิ่มเป็นสิบตัว สองตัวกลายเป็นหนึ่งในห้า และหน้าจอแรกดูแห้งลงมาก
 * จึงเปิดฟรีเป็นสี่ตัว โดยเลือกให้สกิลวิเศษต่างกันครบทั้งสี่แบบ
 * (กวาดรอบตัว · ถล่มจากฟ้า · พุ่งทะยาน · ดูดคริสตัล)
 * เพื่อให้การเลือกตอนเริ่มเกมเป็นการเลือกวิธีเล่นจริง ไม่ใช่เลือกแค่รูป
 *
 * ที่เหลืออีกหกตัวยังต้องซื้อ ซึ่งยังเหลือเป้าหมายให้ไล่เก็บอีกยาว
 */
