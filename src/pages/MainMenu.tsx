...
const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    art: { kind: 'monster', id: 'math-guardian' },
    glow: '#22d3ee',
    label: 'Safe Zone Guardians',
    description: 'ผจญภัยสามมิติในซากเมือง แล้วคำนวณทรัพยากรของโดม',
  ...
  /*
   * แผงคุณครูอยู่ท้ายสุดโดยตั้งใจ
   *
   * เด็กไม่ได้ผิดอะไรถ้ากดเข้าไป ในนั้นไม่มีอะไรให้แก้และไม่มีข้อมูลของคนอื่น
   * แต่มันไม่ใช่ของเล่น การวางไว้กลางเมนูจะแย่งความสนใจจากสิ่งที่เด็กควรกด
   */
  {
    to: '/teacher',
    emoji: '📋',
    label: 'แผงคุณครู',
    description: 'รวมรหัสผลการเรียนของทั้งห้อง ดูว่าตัวชี้วัดไหนควรสอนซ้ำ',
    accent: 'from-gold-500/25 to-slate-600/10',
  },
]
