...
export interface QuestionMetadata {
  operation?: string
  /**
   * ตัวเลขที่ใช้ในโจทย์ เรียงตามที่ปรากฏ
   *
   * เก็บไว้เพื่อสร้างเฉลยแบบทีละขั้นได้อย่างแม่นยำ
   * ทางเลือกอื่นคือแกะตัวเลขจากตัวโจทย์ซึ่งเป็นข้อความ
   * แต่ตัวโจทย์มีลูกน้ำคั่นหลักพันและมีหน่วยปนอยู่ การแกะจึงผิดได้ง่าย
   * และจะผิดเงียบ ๆ คือได้เฉลยที่ดูสมเหตุสมผลแต่เป็นเลขคนละตัว
   */
  operands?: number[]
